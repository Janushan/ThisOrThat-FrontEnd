...
export default class Question extends Component {
  state = {
    ...
    image2Url: "",
    urlOption1:
      "https://images.unsplash.com/photo-1560363199-a1264d4ea5fc?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1534&q=80",
    urlOption2:
      "https://images.unsplash.com/photo-1570871303513-6faf999850fe?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=375&q=80",
    urlOption3:
      "https://images.unsplash.com/photo-1572324755260-ec8c3e7fae29?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=237&q=80",
    urlOption4:
      "https://images.unsplash.com/photo-1518823526-0df532eb95a8?ixlib=rb-1.2.1&auto=format&fit=crop&w=667&q=80",
  ...
  submit = (e) => {
    ...
    try {
      axios
        .post("https://thisorthat-260419.appspot.com/api/questions", {
  ...
  search = () => {
    ...
    fetch(fetchString, {
      ...
      headers: {
        ...
        Authorization:
          "Bearer 8b227e84043e03edfc04b0314134dd779c95415f5ca8a8564fb3a9f23174587c"
      }
      ...
      <div className="wrapper">
        <Card className="loginCard creatorCard" raised>
          <div>
              ...
              InputProps={{
                endAdornment: (
                  <InputAdornment position="end">
                    <input
                      name="image1"
                      onChange={this.image1SelectedHandler}
                      accept="image/*"
                      className="fileInput"
                      id="image1Uploader"
                      type="file"
                    ...
                    <label>
                      <Tooltip title="Select image from Unsplash">
                        <IconButton
                          aria-label="select image from unsplash"
                          component="span"
                    ...
                    >
                      <DialogTitle id="alert-dialog-title">
                        {"This: Search for an image on Unsplash"}
                      </DialogTitle>
                      <DialogContent>
                        <TextField
                          name="searchString"
                        ...
                        <GridList id="gridList1">
                          <GridListTile>
                            <img
                              onClick={this.selectUnsplashUrl1.bind(
                                this,
                                this.state.urlOption1
                              )}
                              src={this.state.urlOption1}
                              alt="imageOption1"
                            />
                          </GridListTile>
                          <GridListTile>
                            <img
                              onClick={this.selectUnsplashUrl1.bind(
                                this,
                                this.state.urlOption2
                              )}
                              src={this.state.urlOption2}
                              alt="imageOption2"
                            />
                          </GridListTile>
                          <GridListTile>
                            <img
                              onClick={this.selectUnsplashUrl1.bind(
                                this,
                                this.state.urlOption3
                              )}
                              src={this.state.urlOption3}
                              alt="imageOption3"
                            />
                          </GridListTile>
                          <GridListTile>
                            <img
                              onClick={this.selectUnsplashUrl1.bind(
                                this,
                                this.state.urlOption4
                              )}
                              src={this.state.urlOption4}
                              alt="imageOption4"
                            />
                          </GridListTile>
                        </GridList>
            ...
            />
            <br />
            <Grid className="creatorImageContainer">
              <img className="creatorImage" src={this.state.image1Url} alt="" />
            </Grid>
            <br />
            <br />
            <TextField
              ...
              InputProps={{
                endAdornment: (
                  <InputAdornment position="end">
                    <input
                      name="image2"
                      onChange={this.image2SelectedHandler}
                      accept="image/*"
                      className="fileInput"
                      id="image2Uploader"
                      type="file"
                    ...
                    >
                      <DialogTitle id="alert-dialog-title">
                        {"That: Search for an image on Unsplash"}
                      </DialogTitle>
                      <DialogContent>
                        <TextField
                          name="searchString"
                        ...
                        <GridList id="gridList2">
                          <GridListTile>
                            <img
                              onClick={this.selectUnsplashUrl2.bind(
                                this,
                                this.state.urlOption1
                              )}
                              src={this.state.urlOption1}
            ...
            />
            <Grid className="creatorImageContainer">
              <img className="creatorImage" src={this.state.image2Url} alt="" />
            </Grid>
            <br />
            <Button
